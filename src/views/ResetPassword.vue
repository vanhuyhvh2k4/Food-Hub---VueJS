<template>
    <main :class="$style.wrapper">
        ...
        <form @submit.prevent="handleSubmitForm">
            <Input @input-enter="handleInputNewPassword" title="New password" placeholder="Enter new password"
                isRequired type="password" autocomplete="new-password" :minLength='6' :isFailed="isFailed" />
            <Input @input-enter="handleInputConfirmPassword" title="Confirm password" placeholder="Confirm the password"
                isRequired type="password" autocomplete="new-password" :minLength='6' :isFailed="isFailed" />
